...
## Corpus Check
- 81 files · ~66,226 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 696 nodes · 782 edges · 53 communities (45 shown, 8 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 18 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f3abf76e`
...
5. `../../config/temuan_service.dart` - 9 edges
6. `../../config/ulp_service.dart` - 8 edges
7. `package:flutter/foundation.dart` - 7 edges
8. `../../config/temuan_types.dart` - 7 edges
9. `AppDelegate` - 6 edges
10. `package:flutter/services.dart` - 6 edges
...
Cohesion: 0.05
Nodes (34): ../../config/app_theme.dart, AdminApprovalScreen, _AdminApprovalScreenState, build, _buildEmpty, Center, Container, Divider (+26 more)
...
Cohesion: 0.06
Nodes (33): _applyFilters, build, _buildActionButtons, _buildDateButton, _buildFilterSection, _buildMultiSelectChip, _buildSelectionHeader, _buildTemuanList (+25 more)
...
Cohesion: 0.09
Nodes (19): ../../config/temuan_model.dart, _dateOnly, DateTime, _matchesIntFilter, _matchesStringFilter, ExportTemuanPdfGenerator, _formatDate, _formatDateTime (+11 more)
...
Cohesion: 0.12
Nodes (14): main, _temuan, TemuanModel, main, main, main, dart:io, dart:typed_data (+6 more)
...
Cohesion: 0.2
Nodes (9): deleteFoto, deleteFotos, Exception, _getContentType, TemuanService, package:file_picker/file_picker.dart, sosialisasi_model.dart, temuan_model.dart (+1 more)
...
## Knowledge Gaps
- **518 isolated node(s):** `MainActivity`, `-registerWithRegistry`, `MyApp`, `_MyAppState`, `main` (+513 more)
...
- **Why does `package:flutter/material.dart` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`?**
  _High betweenness centrality (0.389) - this node is a cross-community bridge._
- **Why does `../../config/temuan_model.dart` connect `Community 12` to `Community 0`, `Community 1`, `Community 3`, `Community 5`, `Community 6`, `Community 8`, `Community 14`, `Community 17`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `package:supabase_flutter/supabase_flutter.dart` connect `Community 23` to `Community 5`, `Community 7`, `Community 10`, `Community 11`, `Community 17`, `Community 18`, `Community 19`, `Community 24`?**
